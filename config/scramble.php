...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API du classement des entreprises de Côte d\'Ivoire, basé sur les retours (avis, entretiens, missions) des personnes ayant travaillé avec elles. Les endpoints en écriture nécessitent un token Bearer (Sanctum).',
    ],
