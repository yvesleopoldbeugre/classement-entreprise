<x-layout :title="'Donner mon avis · '.$entreprise->nom">
    <div class="mx-auto max-w-2xl px-4 py-10">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6">
            <h1 class="text-xl font-bold text-slate-900">Donner mon avis</h1>
            <p class="mb-6 mt-1 text-sm text-slate-500">Sur <span class="font-medium text-slate-700">{{ $entreprise->nom }}</span>. Publié après modération.</p>
