...
// Génère public/og-image.png (1200x630) — carte de partage de marque Note ta boîte.
...
imagettftext($im, 32, 0, 250, 145, $white, $font, 'Note ta boîte');
imagettftext($im, 15, 0, 252, 178, $indigo1, $font, 'notetaboite.com · CÔTE D’IVOIRE');
